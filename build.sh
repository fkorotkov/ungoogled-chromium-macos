...
sed 's/google_api_key=""/google_api_key="AIzaSyCKhPs7c13je-yniPj0MalwqzSSdFOQggw"/g'; 's/google_default_client_id=""/google_default_client_id="531045858063-me228smff1cv9dllepdrerpbeaouqkhn.apps.googleusercontent.com"/g'; 's/google_default_client_secret=""/google_default_client_secret="Dkci1fjLzb5NsE-nUp1Qw4Zj"/g' "$_src_dir/out/Default/args.gn"
